...
class PriorityQueue<T> {
    ...
    func push(_ value: T) {
        ...
        while !comparing(heap[parentIndex], heap[valueIndex]) { heap.swapAt(valueIndex, parentIndex)
    ...
    func pop() -> T? {
        ...
        func isChildEmpty(_ value: Int,_ left: Int,_ right: Int) -> Bool { if heap.count <= left { return true }
